apos.define('apostrophe-i18n-content', {
  ...
  construct: function(self, options) {
    ...
    self.addFieldType = function() {
      console.log('Registering field type multilingual-string');
    ...
    self.populate = function(object, name, $field, $el, field, callback) {
      ...
      var translations = {};
      if (currentValue && currentValue._translations && typeof currentValue._translations === 'object') {
    ...
    self.convert = function(object, name, $field, $el, field, callback) {
      ...
      // Ensure we have _translations property
      if (!parsed._translations) {
        parsed._translations = {};
      }
      
      // Ensure all locales have at least empty string
      _.each(self.locales, function(locale) {
        if (!parsed._translations[locale]) {
          parsed._translations[locale] = '';
        }
      });
      ...
      if (field.required) {
        var hasContent = _.some(parsed._translations, function(text) {
