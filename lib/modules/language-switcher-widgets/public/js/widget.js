...
apos.utils.widgetPlayers['language-switcher'] = function(el, data, options) {
  ...
  function updateTranslationsFromMap(locale) {
    ...
    try {
      ...
      var updatedCount = 0;
      var pageTitleTranslationId = null;
      var pageTitleTranslation = null;
      ...
      document.querySelectorAll('[data-translation-id]').forEach(function(element) {
        ...
        if (translationsMap[translationId] && translationsMap[translationId][locale]) {
          var translation = translationsMap[translationId][locale];
          ...
          if (element.tagName === 'META') {
            ...
            // If this is the SEO title meta tag, remember its translation for page title
            if (element.getAttribute('name') === 'title' || element.getAttribute('property') === 'og:title') {
              pageTitleTranslationId = translationId;
      ...
      // Update page title if we have a translation for the SEO title
      if (pageTitleTranslationId && pageTitleTranslation) {
