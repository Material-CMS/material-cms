module.exports = {
  ...
  addFields: [
    ...
    },
    {
      ...
      type: 'string',
      label: 'Button Text',
      help: 'Change text of bottom bar button to something more personal than "more" or "read"'
    },
    {
      name: 'extraLink',
      label: 'Extra Link',
  ...
  arrangeFields: [
    ...
    },
    {
      name: 'options',
      label: 'Options',
      fields: [ 'blogOn', 'sideImage', 'sideImageLeft', 'topImage', 'extraLink', 'linkText', 'titleShow' ]
    },
    {
      name: 'info',
      label: 'Info',
