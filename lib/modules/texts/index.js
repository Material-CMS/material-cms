module.exports = {
  ...
  addFields: [
    ...
    },
    {
      ...
      type: 'select',
      label: 'Blog On',
      help: 'Text content is now opened in a separate page and will be shown as a blog entry with social share buttons ( ONLY WORKS WITH ACTIVE TEXT PAGE, SO YOU NEED TO ADD ONE TO ACTIVATE THIS FEATURE )',
      choices: [
        {
          label: 'No',
          value: false,
