module.exports = {
  ...
  addFields: [
    ...
    },
    {
      ...
      help: 'Choose to show indicators (default: Yes)',
      choices: [
        {
          label: 'Yes',
          value: true,
          def: true,
          showFields: ['indicatorsBottom']
        },
        {
          label: 'No',
          value: false
  ...
  arrangeFields: [
    ...
    },
    {
      name: 'colors',
      label: 'Colors',
      fields: [ 'gradientColorTop', 'gradientColorBottom', 'headerColor', 'shapeFillColor' ]
    },
    {
      name: 'options',
      label: 'Options',
      fields: [ 'title', 'animated', 'sliderHalf', 'indicatorsOn', 'indicatorsBottom' ]
    }
  ]
};
