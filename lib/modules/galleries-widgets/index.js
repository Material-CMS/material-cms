module.exports = {
  ...
  addFields: [
    ...
    },
    {
      ...
      help: 'Choose shadow for galleries. (Default: No)',
      def: true
    },
    {
      name: 'backColor',
  ...
  arrangeFields: [
    ...
    },
    {
      name: 'options',
      label: 'Options',
      fields: ['imagesTitlesDisplay', 'galleriesTitlesDisplay', 'galleriesTitlesAlign', 'galleriesTitlesColor', 'shadow']
    }
  ],
  filters: {
    projection: {
      ...
      _images: true,
      linkImage: true,
      imagesContainerHeight: 1,
      forceAspectRatio: 1,
      clickActionLightbox: 1
    }
  }
};
