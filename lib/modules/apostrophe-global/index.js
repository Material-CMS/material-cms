...
module.exports = {
  ...
  // Fields Arrangement
  arrangeFields: [
    { name: 'about', label: 'About', fields: [ 'phone', 'email', 'facebook', 'instagram', 'linkedin', 'twitter' ] },
    { name: 'legal', label: 'Legal Info', fields: [ 'copyright', 'creation_date', 'privacy', 'legal', 'creation_date' ] },
    { name: 'tym', label: 'Thank You Message', fields: [ 'thankYouMessage' ] },
    { name: 'styles', label: 'Additional Styles', fields: [ 'additionalStyles' ] },
  ]
};
