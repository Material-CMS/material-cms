module.exports = {
  addFields: [
    ...
    },
    {
      ...
      label: 'Zip',
      type: 'string',
      help: 'Add an zip address which will be shown in footer.',
    },
    {
      name: 'city',
      label: 'City',
    ...
    { // Disclaimers
      ...
      help: 'Add your data privacy and protection disclaimer here (will be shown in all footers).',
      type: 'area',
      options: {
        widgets: {
         'i18n-text': {
    ...
    },
    {
      name: 'legal',
      label: 'Legal Info',
      help: 'Add imprint or legal disclaimer here (will be shown in all footers).',
      type: 'area',
      options: {
        widgets: {
          'i18n-text': {
