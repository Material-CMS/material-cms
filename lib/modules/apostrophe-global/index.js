  ...
  arrangeFields:[
    {
      name: 'about',
      label: 'About',
      fields: ['showContactButton', 'phone', 'email', 'facebook', 'instagram', 'linkedin', 'twitter']
    },
    {
      name: 'navigation',
      label: 'Navigation',
      fields: ['nav', '_logo', '_navBackgroundImage', 'gradientColorTop', 'gradientColorBottom', 'navShadow', 'navGoBack', 'linksArray']
    },
    {
      name: 'footer',
      label: 'Footer',
