module.exports = {
  beforeConstruct: function(self, options) {
    ...
    options.arrangeFields = [
      ...
      { name: 'options', label: 'Options', fields: [ 'titleColor', 'descriptionColor', 'align', 'credit', 'creditUrl', ] },
      { name: 'info', label: 'Info', fields: [ 'camera', 'slug', 'tags', 'published', 'captureDate' ] },
    ]
  }
}
