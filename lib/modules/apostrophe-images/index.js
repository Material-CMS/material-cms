module.exports = {
  beforeConstruct: function(self, options) {
    ...
    options.arrangeFields = [
      { name: 'basics', label: 'Basics', fields: [ 'attachment', 'title', 'description'  ] },
      { name: 'options', label: 'Options', fields: [ 'titleColor', 'descriptionColor', 'align' ] },
      { name: 'info', label: 'Info', fields: [ 'credit', 'creditUrl', 'camera', 'captureDate', 'slug', 'tags', 'published' ] },
    ]
  }
}
