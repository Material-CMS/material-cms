...
module.exports = {
  ...
  beforeConstruct: function(self, options) {
    ...
    options.arrangeFields = options.arrangeFields || [
      { name: 'basic', label: 'Basics', fields: ['title', 'slug', 'text', 'startDate', 'allDay', 'startTime', 'endTime'] },
      { name: 'advanced', label: 'Advanced', fields: ['dateType', 'endDate', 'repeatInterval', 'repeatCount', 'icon', 'active'] },
