	...
	arrangeFields: [
		{
			name: 'basics',
			label: 'Basics',
			fields: ['title', 'columnCount', 'galleryType', '_images', 'linkImage']
  	},
		{
			name: 'colors',
			label: 'Colors',
  	...
  	},
		{
			name: 'options',
			label: 'Options',
			fields: ['container', 'card', 'imagesShadow', 'imagesContainerHeight', 'forceAspectRatio', 'titleDisplay', 'titleAlign']
		},
		{
			name: 'info',
			label: 'Info',
