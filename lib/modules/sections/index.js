module.exports = {
  ...
  addFields: [
    ...
    },
    {
      ...
      help: 'Optional header for section (h1)'
    },
    {
      name: 'headerAlign',
      type: 'select',
      label: 'Header Text Align',
      help: 'Header text align (left, center, right)',
      choices: [
        {
          label: 'Left',
          value: 'left-align',
    ...
    },
    {
      ...
      type: 'color',
      label:'Header Color',
      help: 'Individual header color (default: Accent Color)'
    },
    {
    ...
    },
    {
      ...
      type: 'boolean',
      label: 'Section Slide',
      help: 'Activate fullscreen slider for section',
      def: false
    },
    {
