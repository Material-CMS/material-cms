  ...
  arrangeFields: [
    {
      name: 'section',
      label: 'Section',
      fields: ['title', 'sectionStyle', 'header', 'headerAlign']
    },
    {
      name: 'images',
      label: 'Images',
    ...
    },
    {
      name: 'special',
      label: 'Shape Divider',
      fields: [ 'shapeFillTop', 'shapeFillTopInvert', 'shapeFillBottom', 'shapeFillBottomInvert', 'shapeFillHeight']
    },
    {
      name: 'colors',
      label: 'Colors',
